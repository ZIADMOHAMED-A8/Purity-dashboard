...
export default function WealthCard(){
    return(
        <>
            <article className='bg-white flex px-3 justify-center sm:px-4 rounded-2xl flex-[2] items-center shadow-sm hover:shadow-md transition-shadow overflow-hidden w-full'>
